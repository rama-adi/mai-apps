/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc worker-configuration.d.ts` (hash: 594e119c22a7fc9597a94b7b3b44660a)
// Runtime types generated with workerd@1.20260317.1 2026-03-17 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    MAIAPP_SONGS_CACHE: KVNamespace;
