...
const AtomDotxmlRoute = AtomDotxmlRouteImport.update({
            id: '/atom.xml',path: '/atom.xml',getParentRoute: () => rootRouteImport
          }as any)
