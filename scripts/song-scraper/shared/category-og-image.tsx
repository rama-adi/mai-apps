...
interface CategoryOgMarkupProps {
  title: string;
  color: string;
  logoDataUrl: string;
}

export function CategoryOgImage({ title, color, logoDataUrl }: CategoryOgMarkupProps) {
  const titleFontSize =
...
export async function generateCategoryOgImage(
  ...
  const markup = CategoryOgImage({ title, color, logoDataUrl });
